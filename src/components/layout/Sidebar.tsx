...
import {
  Dashboard as DashboardIcon, People, Business, TrendingUp,
  EventNote, History, Description, BarChart, Settings, Logout,
  ...
  return (
    ...
    >
      <Box sx={{ p: 2.5, display: 'flex', alignItems: 'center', gap: 1.5 }}>
        <Avatar sx={{ bgcolor: '#fff', color: '#28509E', fontWeight: 700, width: 40, height: 40 }}>A</Avatar>
        <Box>
          <Typography variant="h6" sx={{ color: '#fff', fontWeight: 700, fontSize: '1.1rem', lineHeight: 1.2 }}>
            ACHI
          </Typography>
          <Typography sx={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.7rem', letterSpacing: '0.1em' }}>
            SCAFFOLDING CRM
          </Typography>
        </Box>
      </Box>
          ...
          return (
            <ListItemButton
              ...
              sx={{
                ...
                '&:hover': { bgcolor: active ? 'rgba(255,255,255,0.22)' : 'rgba(255,255,255,0.08)' },
              }}
            >
      ...
      <List sx={{ px: 1.5, pb: 2 }}>
        ...
        >
          ...
          <ListItemText primary="Logout" primaryTypographyProps={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.85)' }} />
        </ListItemButton>
      </List>
    </Drawer>
  );
